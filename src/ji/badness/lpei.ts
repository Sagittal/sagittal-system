import { Cents, computeCentsFromPitch, Rational, ScaledVector } from "@sagittal/general"
...
const computeLpei = (jiPitch: ScaledVector<Rational>, centUnit: Cents = MINA_CENTS): LPEI => {
