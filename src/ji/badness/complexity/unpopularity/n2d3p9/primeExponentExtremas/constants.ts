import { Count, Decimal, Exponent, Extrema, Prime } from "@sagittal/general"

const EMPTY_PRIME_EXPONENT_EXTREMA = [0, 0] as Extrema<{
...
export { EMPTY_PRIME_EXPONENT_EXTREMA, INITIAL_PRIME_EXPONENT_EXTREMAS_FOR_TWO_AND_THREE }
