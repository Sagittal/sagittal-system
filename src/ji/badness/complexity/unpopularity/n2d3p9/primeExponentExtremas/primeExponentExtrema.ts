...
const computePrimeExponentExtremaGivenMaxN2D3P9 = (
    ...
    const maxNumeratorPrimeExponentGivenMaxN2D3P9: Max<
    ...
    const maxDenominatorPrimeExponentGivenMaxN2D3P9: Max<
        Denominator & Decimal<{ integer: true }> & Exponent<Prime>
    > = mirrored
        ? (maxNumeratorPrimeExponentGivenMaxN2D3P9 as Max<
              Decimal<{ integer: true }> & Exponent<Prime>
          > as Max<Denominator & Decimal<{ integer: true }> & Count<Prime> & Exponent<Prime>>)
        : computeMaxDenominatorPrimeExponentGivenMaxN2D3P9(
    ...
    return [
        negative(maxDenominatorPrimeExponentGivenMaxN2D3P9) as number as Min<
            Decimal<{ integer: true }> & Count<Prime> & Exponent<Prime>
        >,
        maxNumeratorPrimeExponentGivenMaxN2D3P9 as number as Max<
            Decimal<{ integer: true }> & Count<Prime> & Exponent<Prime>
        >,
    ]
}

export { computePrimeExponentExtremaGivenMaxN2D3P9 }
