import {Count, Decimal, Exponent, Extrema, Max, Min, Numerator, Prime} from "@sagittal/general"
...
const computeNumeratorPrimeExponentExtremasGivenMaxN2D3P9 = (
    ...
    return maxNumeratorPrimeExponentsGivenMaxN2D3P9.map((
        maxNumeratorPrimeExponentGivenMaxN2D3P9: Max<Numerator & Decimal<{integer: true}> & Count<Prime> & Exponent<Prime>>,
    ): Extrema<{of: Decimal<{integer: true}> & Count<Prime> & Exponent<Prime>}> => {
        return [0 as Min<Decimal<{integer: true}> & Count<Prime> & Exponent<Prime>>, maxNumeratorPrimeExponentGivenMaxN2D3P9]
    })
}
