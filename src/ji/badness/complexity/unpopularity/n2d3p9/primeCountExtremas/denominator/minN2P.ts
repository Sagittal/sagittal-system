...
const computeMinN2PForPossibleMaxDenominatorPrimeCountGivenMaxN2D3P9 = (
    ...
    const possibleMaxDenominatorPower = pow(denominatorPrime, possibleMaxDenominatorPrimeCountGivenMaxN2D3P9)

    const actualNumeratorPossibilityWithLesserGpfThanDenominatorPrimeWithLeastN2 =
        sortedNumeratorPossibilitiesGivenMaxN2D3P9WithLesserGpfThanDenominatorPrimeSortedByN2.find(
            (
    ...
    const fromNumeratorsWithLesserGpfThanDenominatorPrimeDenominatorPowerMinN2P: Min<N2P> =
        actualNumeratorPossibilityWithLesserGpfThanDenominatorPrimeWithLeastN2
            ? ((actualNumeratorPossibilityWithLesserGpfThanDenominatorPrimeWithLeastN2.n2 *
                  denominatorPrime) as Min<N2P>)
            : (Infinity as Min<N2P>)

    const actualNumeratorPossibilityWithGreaterGpfThanDenominatorPrimeWithLeastN2P =
        sortedNumeratorPossibilitiesGivenMaxN2D3P9WithGreaterGpfThanDenominatorPrimeSortedByN2P.find(
            (
...
export { computeMinN2PForPossibleMaxDenominatorPrimeCountGivenMaxN2D3P9 }
