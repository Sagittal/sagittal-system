import { computeRationalDecimalGpf, Max, Numerator, Prime } from "@sagittal/general"
...
const computeNumeratorPossibilitiesForDenominatorGivenMaxN2D3P9 = (
    ...
    return possibleNumeratorsGivenMaxN2D3P9.map(
        (possibleNumerator: Numerator): NumeratorPossibilityForDenominatorGivenMaxN2D3P9 => {
            return {
...
export { computeNumeratorPossibilitiesForDenominatorGivenMaxN2D3P9 }
