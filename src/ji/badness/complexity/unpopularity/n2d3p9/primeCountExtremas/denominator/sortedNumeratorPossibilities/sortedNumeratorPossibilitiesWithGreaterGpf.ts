...
}: SortedNumeratorPossibilitiesOptions): SortedNumeratorPossibilityWithGreaterGpfThanDenominatorPrimeIncludingN2P[] => {
    const numeratorPossibilitiesWithGreaterGpf: NumeratorPossibilityWithGreaterGpfThanDenominatorPrime[] =
        numeratorPossibilitiesForDenominatorGivenMaxN2D3P9.filter(
            (numeratorPossibility: NumeratorPossibilityForDenominatorGivenMaxN2D3P9): boolean => {
                return (
                    numeratorPossibility.gpf > denominatorPrime &&
                    !dividesEvenly(numeratorPossibility.numerator, denominatorPrime)
                )
            },
        ) as NumeratorPossibilityWithGreaterGpfThanDenominatorPrime[]
    const numeratorPossibilitiesWithGreaterGpfIncludingN2P = numeratorPossibilitiesWithGreaterGpf.map(
        (
...
export { computeSortedNumeratorPossibilitiesGivenMaxN2D3P9WithGreaterGpfThanDenominatorPrimeSortedByN2P }
