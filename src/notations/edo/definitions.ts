import { EdoName, EdoNotationDefinition } from "./types"

const EDO_NOTATION_DEFINITIONS: Record<EdoName, EdoNotationDefinition> = {
    "5": { sagitypes: [] },
    "6": { supersetEdoName: "12" },
    "7": { isLimmaFraction: true, sagitypes: [] },
    "8": { supersetEdoName: "24" },
    "9": { isLimmaFraction: true, sagitypes: ["|\\"] },
    "10": { sagitypes: ["(|\\"] },
    "11": { supersetEdoName: "22" },
    "12": { sagitypes: [] },
    "13": { supersetEdoName: "26" },
    "14": { isLimmaFraction: true, sagitypes: ["|\\"] },
    "15": { sagitypes: ["/|"] },
    "16": { isLimmaFraction: true, sagitypes: ["|)"] },
    "17": { sagitypes: ["/|\\"] },
    "18": { supersetEdoName: "36" },
    "19": { sagitypes: [] },
    "20": { sagitypes: [")~|", "(|\\"] },
    ...
    "29": { sagitypes: ["/|"] },
    "30": { sagitypes: [")|", "/|", "(|\\"] },
    "30b": { isLimmaFraction: true, sagitypes: ["|(", "|)"] },
    "31": { sagitypes: ["/|\\"] },
    "32": { sagitypes: [")~|", "/|"] },
    ...
    "41": { sagitypes: ["/|", "/|\\"] },
    "42": { sagitypes: [")|", "/|", "/|)"] },
    "42b": { isLimmaFraction: true, sagitypes: ["|(", "|)", "|\\"] },
    "43": { sagitypes: ["|)"] },
    "44": { sagitypes: [")|", "/|", "(|\\"] },
    "45": { sagitypes: ["/|)"] },
    "46": { sagitypes: ["/|", "/|\\"] },
    ...
    "72": { sagitypes: ["/|", "|)", "/|\\"] },
    "75": { sagitypes: ["|\\", "/|", "/|\\", "(|\\"] },
    "76": { supersetEdoName: "152" },
    "79": { sagitypes: ["/|", "|)", "/|\\"] },
    "80": { sagitypes: ["|)", "/|", "(|(", "/|\\"] },
    "84": { sagitypes: ["/|", "|)", "/|)"] },
    "87": { sagitypes: ["|~", "/|", "/|~", "/|\\"] },
    "88": { supersetEdoName: "176" },
    "89": { sagitypes: ["/|", "|)", "/|)", "/|\\"] },
    "94": { sagitypes: ["~|(", "/|", "(|(", "/|"] },
    "99": { sagitypes: ["~|", "/|", "~|)", "//|", ")/|\\"] },
    "111": { sagitypes: [")|(", "/|", "|\\", "//|", "/|\\"] },
    "112": { supersetEdoName: "224" },
    "118": { sagitypes: [")|(", "/|", "|)", "//|", "/|\\"] },
...
} as Record<EdoName, EdoNotationDefinition>
