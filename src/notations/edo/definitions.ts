...
const EDO_NOTATION_DEFINITIONS: Record<EdoNotationName, EdoNotationDefinition> = {
    ...
    "23b": {
        stepDefinitions: [{ sagitype: ")|" }, { sagitype: "/|" }, { sagitype: "(|\\" }],
    },
    ...
    "47b": {
        stepDefinitions: [{ sagitype: ")|" }, { sagitype: ")~|" }, { sagitype: "/|" }, { sagitype: "(|\\" }],
    },
    "48": {
        stepDefinitions: [
    ...
    "50": {
        stepDefinitions: [{ sagitype: "/|)", validCommas: [undefined, "13M"] }],
    },
    "51": {
        stepDefinitions: [
