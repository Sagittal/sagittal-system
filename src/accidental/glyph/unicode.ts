...
const CORE_UNICODE_EQUIVALENTS: Array<{ core: Core; unicode: Unicode }> = [
    ...
    {
        core: getCore(HeadId.LEFT_SCROLL_DOUBLE_LEFT_BARB, { shafts: Shafts.DOUBLE }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.ARC_AND_BOATHOOK, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.BARB_AND_ARC, { shafts: Shafts.DOUBLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.LEFT_SCROLL_DOUBLE_LEFT_BARB, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.DOUBLE_LEFT_BARB, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.BOATHOOK_AND_BARB, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.ARC_AND_SCROLL, { shafts: Shafts.DOUBLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.BARB_AND_BOATHOOK, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.BOATHOOK_AND_ARC, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.LEFT_SCROLL_AND_BARB, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.SCROLL_AND_BOATHOOK, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.LEFT_BARB, { shafts: Shafts.DOUBLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.DOUBLE_LEFT_BOATHOOK, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.BOATHOOK_AND_SCROLL, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.RIGHT_BOATHOOK, { shafts: Shafts.DOUBLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.LEFT_SCROLL_AND_BOATHOOK, { shafts: Shafts.DOUBLE, down: true }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.LEFT_SCROLL_DOUBLE_LEFT_BARB, { shafts: Shafts.TRIPLE }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.LEFT_SCROLL_DOUBLE_RIGHT_BARB, { shafts: Shafts.TRIPLE }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.LEFT_SCROLL_AND_BOATHOOK, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.BOATHOOK_AND_SCROLL, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.RIGHT_BOATHOOK, { shafts: Shafts.TRIPLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.DOUBLE_LEFT_BOATHOOK, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.LEFT_BARB, { shafts: Shafts.TRIPLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.SCROLL_AND_BOATHOOK, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.LEFT_SCROLL_AND_BARB, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.BOATHOOK_AND_ARC, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.ARC_AND_SCROLL, { shafts: Shafts.TRIPLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.BARB_AND_BOATHOOK, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.BOATHOOK_AND_BARB, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.DOUBLE_LEFT_BARB, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.LEFT_SCROLL_DOUBLE_LEFT_BARB, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.BARB_AND_ARC, { shafts: Shafts.TRIPLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.ARC_AND_BOATHOOK, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.DOUBLE_BARB, { shafts: Shafts.TRIPLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.LEFT_ARC_AND_BARB, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.LEFT_SCROLL_AND_DOUBLE_BARB, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.DOUBLE_ARC, { shafts: Shafts.TRIPLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.RIGHT_BARB_AND_ARC, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    { core: getCore(HeadId.ARC_AND_BARB, { shafts: Shafts.TRIPLE, down: true }), unicode: "" as Unicode },
    {
        core: getCore(HeadId.DOUBLE_RIGHT_BARB, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    {
        core: getCore(HeadId.LEFT_SCROLL_DOUBLE_RIGHT_BARB, { shafts: Shafts.TRIPLE, down: true }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.LEFT_SCROLL_DOUBLE_LEFT_BARB, { shafts: Shafts.EX, down: true }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.LEFT_SCROLL_AND_BARB, { shafts: Shafts.EX, down: true }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.DOUBLE_LEFT_BOATHOOK, { shafts: Shafts.EX, down: true }),
        unicode: "" as Unicode,
    },
    ...
    {
        core: getCore(HeadId.LEFT_SCROLL_AND_BOATHOOK, { shafts: Shafts.EX, down: true }),
        unicode: "" as Unicode,
    },
...
const computeCoreUnicode = (core: Core): Unicode => {
    const maybeEquivalent = CORE_UNICODE_EQUIVALENTS.find((equivalent: { core: Core }): boolean =>
        deepEquals(equivalent.core, core),
    )
...
const computeCompatibleUnicode = (compatible: Compatible): Unicode => COMPATIBLE_TO_UNICODE_MAP[compatible]
...
const computeAccidentalUnicode = <T extends Maybe<Flavor> = undefined>(
    ...
    const compatibleUnicode = isUndefined(compatible) ? BLANK_UNICODE : computeCompatibleUnicode(compatible)
