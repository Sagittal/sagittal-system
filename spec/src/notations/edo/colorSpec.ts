import { HexColor, indexOf } from "@sagittal/general"
import {
    computeSectionColor,
...
const BEST_FIFTH_SECTION_COLORS_FROM_PT: Record<SectionColor, EdoNotationName[]> = {
    [SectionColor.BLACK]: [],
    [SectionColor.GOLD]: [
        "5",
        "6",
    ...
    [SectionColor.GREEN]: ["22", "27", "44", "49", "54", "59", "61", "66", "71"] as EdoNotationName[],
    [SectionColor.BLUE]: ["17", "34", "39", "46", "51", "56", "63", "68"] as EdoNotationName[],
    [SectionColor.MAGENTA]: ["29", "58", "70"] as EdoNotationName[],
    [SectionColor.GREY]: ["41", "53", "65"] as EdoNotationName[],
    [SectionColor.ORANGE]: ["12", "24", "36", "48", "60", "72"] as EdoNotationName[],
    [SectionColor.PINK]: [],
    [SectionColor.YELLOW]: ["43", "55", "67"] as EdoNotationName[],
    [SectionColor.CYAN]: ["19", "31", "38", "50", "57", "62", "69"] as EdoNotationName[],
    [SectionColor.PURPLE]: ["26", "45", "52", "59b", "64", "71b"] as EdoNotationName[],
    [SectionColor.ROSE]: [
        "7",
        "9",
        "11",
    ...
    Object.entries(sectionColors).reduce(
        (
            ...
            edoNotationNames.forEach((edoNotationName: EdoNotationName): void => {
                sectionColorsAsHexColorByEdoNotationName[edoNotationName] = sectionColor as HexColor
            })
...
const BEST_FIFTH_SECTION_COLORS_FROM_PT_BY_EDO_NAME_AND_AS_HEX_COLOR: Record<EdoNotationName, HexColor> =
    switchSlicingToBeByEdoNotationNameThenColorAsHexColor(BEST_FIFTH_SECTION_COLORS_FROM_PT)

const sectionColorFromHexColor = (hexColor: HexColor) =>
    Object.keys(SectionColor)[indexOf(Object.values(SectionColor), hexColor as SectionColor)]
    ...
    it("chooses the correct colors for all the EDOs", (): void => {
        ...
        edoNotationNames.forEach((edoNotationName: EdoNotationName): void => {
            ...
            const expected: SectionColor | HexColor =
                BEST_FIFTH_SECTION_COLORS_FROM_PT_BY_EDO_NAME_AND_AS_HEX_COLOR[edoNotationName]
