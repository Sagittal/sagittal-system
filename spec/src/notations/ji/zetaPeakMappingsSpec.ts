import {Mapping} from "@sagittal/general"
import {INSANE_ZETA_PEAK_MAPPING} from "../../../../src"

describe("zeta peak mappings", (): void => {
    it("has the correct standard mapping for the zeta-peak EDO which corresponds to the Insane precision notation's 809-EDA         ", (): void => {
        expect(INSANE_ZETA_PEAK_MAPPING).toEqual([
