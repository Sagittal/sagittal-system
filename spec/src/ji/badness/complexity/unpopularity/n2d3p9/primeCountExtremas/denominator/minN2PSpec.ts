...
} from "../../../../../../../../../src/ji/badness/complexity/unpopularity/n2d3p9/primeCountExtremas/denominator/sortedNumeratorPossibilities/types"

describe("computeMinN2PForPossibleMaxDenominatorPrimeCountGivenMaxN2D3P9", (): void => {
    it("finds the min N2P out of the numerator possibilities where the GPF is greater than the denominator prime, and the min N2P out of the numerator possibilities where the GPF is lesser than the denominator prime, and then returns the min of those two", (): void => {
        ...
        const actual = computeMinN2PForPossibleMaxDenominatorPrimeCountGivenMaxN2D3P9({
